            ...
            >
                <div class="mx-auto max-w-7xl  lg:px-8">
                    <div class="w-full flex flex-col lg:flex-row">
                        ...
                        <div class="hidden w-full lg:flex justify-between max-lg:bg-white py-2 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
                            <ul
                            ...
                            <div
                                class="flex lg:items-center justify-start flex-col lg:flex-row max-lg:gap-2 lg:flex-1 lg:justify-end"
                            >
                                <button
                                    class=" text-indigo-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm"
                                >
                                    Login
                                </button>
                                <button
